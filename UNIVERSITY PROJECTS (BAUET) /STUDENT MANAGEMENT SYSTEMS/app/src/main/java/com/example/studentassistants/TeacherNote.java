...
public class TeacherNote extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText = findViewById(R.id.uploddes);
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        databaseReference.child("ClassNote").push().setValue(putPDF);
                        Toast.makeText(TeacherNote.this, "File Upload", Toast.LENGTH_LONG).show();
