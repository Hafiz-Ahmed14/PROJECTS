...
public class TeacherCt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_ct);

        editText = findViewById(R.id.uplodpf);
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        databaseReference.child("ClassTest").push().setValue(putPDF);
                        Toast.makeText(TeacherCt.this, "File Upload", Toast.LENGTH_LONG).show();
